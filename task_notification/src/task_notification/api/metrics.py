...
@inject
async def metrics(use_case: FromDishka[GetNotificationsMetricsUseCase]) -> Response:
    await use_case.execute()
    return Response(
        content=generate_latest(notifications_registry) + generate_latest(instrumentator.registry),
